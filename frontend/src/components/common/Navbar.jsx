...
const Navbar = () => {
  ...
  const [showArrow, setShowArrow] = useState(false); //Arrow(back/frwrd) icon
  ...
  // Accessing addPostModal(false) from slice.js (Redux)
  const handleAddPost = () => {
  ...
  return (
    <>
      ...
      >
        ...
        {showArrow ? //if showArrow(true) then icon otherwise not
        (
          <FiArrowLeft
            size={_300 ? 32 : 24}
