...
//Any user details msg,likes etc
exports.userDetails = async (req, res) => {
  try {
    ...
    //-pw = Not select pw
    //path:threads of userModel
    //path:reposts of userModel
    //path:replies of userModel
...
exports.followUser = async (req, res) => {
  ...
  try {
    ...
    //userExists.followers. = followers in userModel
    //it will check Us in that users FollowerList , that if we already folloewd him
    ...
    //if we are not folowing that user than...
    await User.findByIdAndUpdate(
      userExists._id,
      {
...
exports.searchUser = async (req, res) => {
  ...
  try {
    ...
    const users = await User.find({
      // $or opr. = it will give result which match one of them
      $or: [
