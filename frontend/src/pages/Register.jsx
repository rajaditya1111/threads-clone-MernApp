...
const Register = () => {
  ...
  //for Responsiveness, if page min. width=700px 
  const _700 = useMediaQuery("(min-width:700px)");

  //from service.js {Redux}
  // const [funcTouse, containsInfolike.error,success] = useMutation()
  ...
  const toggleLogin = () => {
    //pre = {viceversa} if this than that,if that than this
    setLogin((pre) => !pre);
  };
